...
> **Revisión tras la migración de PC (22 de julio de 2026).** TD-016, TD-017, TD-018, TD-025, TD-028 y la gobernanza TD-019 están verificadas: lock, empaquetador, AppTest, gate Git, tema nativo y matriz Linux Python 3.11–3.14. La rama visual pasa 118 pruebas con 80,7 % de cobertura local; Yahoo y las bases reales quedan aislados en AppTest. Las afirmaciones posteriores se conservan como registro histórico y solo coinciden con el estado actual cuando esta nota las confirma.
...
| TD-018 | P1 | Pruebas | Resuelto tras la recuperación: 118 pruebas en la rama visual, cobertura de líneas y ramas del producto de 80,7 % y umbral CI de 75 % | AppTest ejecuta `app.py`, las once vistas y acciones paper simuladas con datos deterministas; Yahoo y las bases reales quedan aislados | Aumentar el umbral gradualmente y cubrir rutas de error/legacy solo según riesgo demostrado |
